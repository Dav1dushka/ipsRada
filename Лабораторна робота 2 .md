...
У ході виконання лабораторної роботи ми ознайомились з інтерфейсами ОС Linux та мобільних операційних систем. Отримали практичні навички роботи в їх середовищі, включаючи запуск програм, зміну налаштувань та управління системними ресурсами.

Також вивчели способи входу та виходу з системи, використання командного рядка та комбінацій клавіш для виконання основних дій. Робота дозволила глибше зрозуміти принципи функціонування операційних систем, що є корисним для подальшого навчання та практичного застосування.
