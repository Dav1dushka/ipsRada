...
The following hardware and software are required for the lessons:
	...
	2.	Windows OS family and VirtualBox virtual machine
	3.	GNU/Linux OS 
	4.	Cisco Networking Academy website and its online Linux courses
---
...
2.5. Brief Overview of Graphical Interfaces in Linux Distributions (GNOME & JWM)
	•	GNOME:
...
These graphical interfaces serve different purposes, with GNOME offering a full-featured experience and JWM being a lightweight alternative.
